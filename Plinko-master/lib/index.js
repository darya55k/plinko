...
const ground2 = Bodies.rectangle(0, CANVAS_HEIGHT - 22, CANVAS_WIDTH * 3, 40, {
  id: 9999,
  isStatic: true,
  collisionFilter: { group: 'ground' }
});
...
for (let i = 1; i < CANVAS_HEIGHT / PEG_Y - 1; i++) {
  for (let j = 1; j < CANVAS_WIDTH / PEG_X + 1; j++) {
    ...
    const peg = Bodies.polygon(x, y, 8, BALL_SIZE / 4, {
...
const bucketHeight = BALL_SIZE * 2.5;
const busketR = 10;
for (let i = 0; i < 10; i++) {
...
let closePopupBtn = document.querySelector('.form__button') 
